"""
HR Agent Tools — TalentFlow Internal HR Agent
Tools:
  1. flag_burnout_risk       — Burnout risk assessment
  2. predict_attrition_risk  — Resignation/flight-risk prediction
  3. match_internal_talent   — Internal mobility matching
  4. add_employee_to_database — Add new employee records
  5. check_leave_balance     — Employee leave entitlement check
  6. generate_onboarding_plan — Day-by-day onboarding plan
  7. analyze_exit_interview  — Exit interview analysis
  8. get_my_meetings         — Check scheduled calendar meetings
  9. draft_email             — Draft professional HR email
 10. send_email_to_candidate — Send email via Gmail SMTP
 11. answer_policy_question  — Policy FAQ from embedded policy text
"""
...
# ---------------------------------------------------------------------------
# TOOL 1 — Burnout Risk Flagging (MongoDB)
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# TOOL 3 — Internal Talent Matcher (MongoDB)
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# TOOL 4 — Add Employee to Database
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# TOOL 6 — Generate Onboarding Plan
# ---------------------------------------------------------------------------
